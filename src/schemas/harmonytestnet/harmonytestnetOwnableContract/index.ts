...
export interface HarmonytestnetOwnableContractType {
  name?: string;
  address: string;
}

export const harmonytestnetOwnableContractSchema: Schema<HarmonytestnetOwnableContractType> = {
  version: 1,
  deploymentBlock: 0,
  name: 'OwnableContract',
  description: 'Harmonytestnet Ownable Smart Contract',
  ...
  formatter:
    async asset => {
      return {
        ...
        url: 'https://harmonytestnet.etherscan.io/address/' + asset.address,
        properties: [],
      };
  },
  functions: {
