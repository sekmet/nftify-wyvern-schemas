...
export interface HarmonytestnetCustomType {
  name: string;
  description: string;
  thumbnail: string;
  url: string;
...
export const harmonytestnetCustomSchema: Schema<HarmonytestnetCustomType> = {
  version: 1,
  deploymentBlock: 0,
  name: 'HarmonytestnetCustom',
  description: 'Harmonytestnet Custom (manual ABI specification)',
