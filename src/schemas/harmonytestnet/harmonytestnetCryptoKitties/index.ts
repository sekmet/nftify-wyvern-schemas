...
export type HarmonytestnetCryptoKittiesType = string;

export const harmonytestnetCryptoKittiesSchema: Schema<HarmonytestnetCryptoKittiesType> = {
  version: 1,
  deploymentBlock: 0,
  name: 'HarmonytestnetCryptoKitties',
  description: 'Harmonytestnet Testnet CryptoKitties',
  ...
  formatter:
    async asset => {
      return {
        thumbnail: 'https://www.cryptokitties.co/images/kitty-eth.svg',
        title: 'HarmonytestnetCryptoKitty #' + asset,
        description: 'A Harmonytestnet kitten!',
