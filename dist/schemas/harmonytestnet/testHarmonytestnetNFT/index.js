...
exports.testHarmonytestnetNFTSchema = void 0;
const ethereum_types_1 = require("ethereum-types");
const types_1 = require("../../../types");
exports.testHarmonytestnetNFTSchema = {
    version: 1,
    deploymentBlock: 0,
    name: 'TestHarmonytestnetNFT',
    description: 'Harmonytestnet ERC721 non-fungible token for Wyvern Exchange testing',
    ...
    formatter: (asset) => __awaiter(void 0, void 0, void 0, function* () {
        return {
            thumbnail: 'https://cointelegraph.com/storage/uploads/view/f88e17e41f607dc0aef238230dd40cc6.png',
            title: 'TestHarmonytestnetNFT #' + asset,
    ...
    events: {
        transfer: [{
                ...
                assetFromInputs: (inputs) => __awaiter(void 0, void 0, void 0, function* () { return inputs._tokenId.toString(); }),
            }],
    },
    hash: a => a,
};
